...
{
public:
    STRtreeExperimentRunner(std::string name, std::string crs, const Coord translation = {0, 0}) : GeosIndexExperimentRunner<geos::index::strtree::STRtree>(name, crs, translation) {}
