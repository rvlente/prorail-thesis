...
{
    std::string data_file_0_25m = "../data/germany-taxi/germany-taxi-0_25m.bin";
    std::string data_file_2_5m = "../data/germany-taxi/germany-taxi-2_5m.bin";
    std::string data_file_25m = "../data/germany-taxi/germany-taxi-25m.bin";
    std::string data_file_250m = "../data/germany-taxi/germany-taxi-250m.bin";

    std::vector<std::string> distance_query_files = {
        "../data/germany-taxi/queries/taxi_distance_0.0001.csv",
        "../data/germany-taxi/queries/taxi_distance_0.001.csv",
        "../data/germany-taxi/queries/taxi_distance_0.01.csv",
        "../data/germany-taxi/queries/taxi_distance_0.1.csv",
        "../data/germany-taxi/queries/taxi_distance_1.csv",
        // "../data/germany-taxi/queries/taxi_distance_10.csv",
        // "../data/germany-taxi/queries/taxi_distance_100.csv"
    };
    std::vector<std::string> range_query_files = {
        "../data/germany-taxi/queries/taxi_range_0.0001.csv",
        "../data/germany-taxi/queries/taxi_range_0.001.csv",
        "../data/germany-taxi/queries/taxi_range_0.01.csv",
        "../data/germany-taxi/queries/taxi_range_0.1.csv",
        "../data/germany-taxi/queries/taxi_range_1.csv",
        // "../data/germany-taxi/queries/taxi_range_10.csv",
        // "../data/germany-taxi/queries/taxi_range_100.csv"
    };
    ...
    auto strtree_runner = STRtreeExperimentRunner("geos_strtree", "EPSG:4839", argv[0]);
    ...
    auto quadtree_runner = QuadtreeExperimentRunner("geos_quadtree", "EPSG:4839", argv[0]);
